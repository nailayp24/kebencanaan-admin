                            ...
                            <div class="text-center">
                                ...
                                <div class="profile-picture-preview mb-3">
                                    <img id="profilePicturePreview"
                                         src="{{ $dataUser->profile_picture ? Storage::url($dataUser->profile_picture) : asset('assets/images/default-avatar.png') }}"
                                ...
                                <div class="col-md-6">
                                    <div class="mb-3">
                                        ...
                                        <select class="form-select @error('role') is-invalid @enderror"
                                            ...
                                            <option value="super_admin" {{ old('role', $dataUser->role) == 'super_admin' ? 'selected' : '' }}>
                                                Super Admin
                                            </option>
                                            <option value="admin" {{ old('role', $dataUser->role) == 'admin' ? 'selected' : '' }}>
                                                Administrator
                                            </option>
                                            <option value="user" {{ old('role', $dataUser->role) == 'user' ? 'selected' : '' }}>
                                                User Biasa
                                            </option>
                                        </select>
                                        @error('role')
                                    ...
                                    <div class="mb-3">
                                        ...
                                        <div class="form-control bg-light">
                                            <div class="d-flex justify-content-between">
                                                ...
                                                <span class="badge bg-{{ $dataUser->role == 'super_admin' ? 'danger' : ($dataUser->role == 'admin' ? 'warning' : 'info') }}">
