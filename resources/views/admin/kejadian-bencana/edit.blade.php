        ...
        <div class="col-12">
            <div class="card">
                <div class="card-header">
                    <h4 class="card-title">Edit Data Kejadian Bencana</h4>
                    <p class="card-title-desc">Perbarui informasi kejadian bencana dengan data yang valid</p>
                </div>
                <div class="card-body">
                    ...
                    <form action="{{ route('kejadian-bencana.update', $kejadian->kejadian_id) }}" method="POST">
                        ...
                        <div style="display: none;">
                            <p>Debug Jenis Bencana: {{ $kejadian->jenis_bencana }}</p>
                            <p>Old Value: {{ old('jenis_bencana') }}</p>
                        </div>
                            ...
                            <div class="col-md-6">
                                <div class="mb-3">
                                    ...
                                    <select class="form-select @error('jenis_bencana') is-invalid @enderror"
                                        ...
                                        <option value="Banjir" {{ old('jenis_bencana', $kejadian->jenis_bencana) == 'Banjir' ? 'selected' : '' }}>
                                            Banjir
                                        </option>
                                        <option value="Tanah Longsor" {{ old('jenis_bencana', $kejadian->jenis_bencana) == 'Tanah Longsor' ? 'selected' : '' }}>
                                            Tanah Longsor
                                        </option>
                                        <option value="Gempa Bumi" {{ old('jenis_bencana', $kejadian->jenis_bencana) == 'Gempa Bumi' ? 'selected' : '' }}>
                                            Gempa Bumi
                                        </option>
                                        <option value="Kebakaran" {{ old('jenis_bencana', $kejadian->jenis_bencana) == 'Kebakaran' ? 'selected' : '' }}>
                                            Kebakaran
                                        </option>
                                        <option value="Angin Puting Beliung" {{ old('jenis_bencana', $kejadian->jenis_bencana) == 'Angin Puting Beliung' ? 'selected' : '' }}>
                                            Angin Puting Beliung
                                        </option>
                                        <option value="Lainnya" {{ old('jenis_bencana', $kejadian->jenis_bencana) == 'Lainnya' ? 'selected' : '' }}>
                                            Lainnya
                                        </option>
                                    </select>
                                    @error('jenis_bencana')
                        ...
                        <div class="mb-3">
                            ...
                            <input type="text" class="form-control @error('lokasi_text') is-invalid @enderror"
                                   id="lokasi_text" name="lokasi_text"
                                   value="{{ old('lokasi_text', $kejadian->lokasi_text) }}"
                                   placeholder="Masukkan lokasi kejadian bencana" required>
                            <div class="form-text">Contoh: Jl. Merdeka No. 10, Dusun Sukamaju</div>
                            @error('lokasi_text')
                                <div class="invalid-feedback">{{ $message }}</div>
                            @enderror
                        </div>
                            ...
                            <div class="col-md-6">
                                <div class="mb-3">
                                    ...
                                    <select class="form-select @error('status_kejadian') is-invalid @enderror"
                                        ...
                                        <option value="dilaporkan" {{ old('status_kejadian', $kejadian->status_kejadian) == 'dilaporkan' ? 'selected' : '' }}>
                                            Dilaporkan
                                        </option>
                                        <option value="diverifikasi" {{ old('status_kejadian', $kejadian->status_kejadian) == 'diverifikasi' ? 'selected' : '' }}>
                                            Diverifikasi
                                        </option>
                                        <option value="ditangani" {{ old('status_kejadian', $kejadian->status_kejadian) == 'ditangani' ? 'selected' : '' }}>
                                            Ditangani
                                        </option>
                        ...
                        <div class="mb-3">
                            ...
                            <div class="form-text">Jelaskan dampak yang ditimbulkan oleh bencana</div>
                            @error('dampak')
                                <div class="invalid-feedback">{{ $message }}</div>
                            @enderror
                        </div>
                        ...
                        <div class="mb-3">
                            ...
                            <div class="form-text">Tambahkan informasi lain yang relevan</div>
                            @error('keterangan')
                                <div class="invalid-feedback">{{ $message }}</div>
                            @enderror
                        </div>
