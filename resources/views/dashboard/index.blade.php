...
<div class="card shadow-sm">
  <div class="card-body">
    <div class="d-flex justify-content-between align-items-center mb-3">
      ...
      <a href="{{ route('kejadian.create') }}" class="btn btn-gradient-success btn-sm">
    ...
    <div class="table-responsive">
      <table class="table table-hover align-middle">
        ...
        <tbody>
          @forelse($kejadian as $item)
            <tr>
              ...
              <td>
                ...
                @else
                  <span class="badge bg-secondary">Belum Ditangani</span>
                @endif
              </td>
          ...
          @empty
            <tr>
              <td colspan="9" class="text-center text-muted">Belum ada data kejadian.</td>
            </tr>
          @endforelse
        </tbody>
      </table>
